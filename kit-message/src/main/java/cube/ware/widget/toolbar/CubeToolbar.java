 ...
 * @date 2017/1/19
 */
public class CubeToolbar extends BaseToolbar implements View.OnClickListener,ICubeToolbar {
    ...
    public CubeToolbar(Context context) {
        super(context);
    }

    public CubeToolbar(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CubeToolbar(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void initCustomView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (!isChild(mTitleLayout)) {
            ...
            addView(mTitleLayout, new Toolbar.LayoutParams(Toolbar.LayoutParams.WRAP_CONTENT, Toolbar.LayoutParams.WRAP_CONTENT, Gravity.CENTER));
            ...
            if (!isChild(mTitleInnerLayout)) {
                ...
                mTitleLayout.addView(mTitleInnerLayout, new Toolbar.LayoutParams(Toolbar.LayoutParams.WRAP_CONTENT, Toolbar.LayoutParams.WRAP_CONTENT, Gravity.CENTER));
            }
        }
        ...
        if (!isChild(mProgressBar,mTitleInnerLayout)) {
            ...
            layoutParams.rightMargin = typedArray.getDimensionPixelSize(R.styleable.CubeToolbar_progressMarginRight, dp2px(DEFAULT_BACK_MARGIN_RIGHT));
        ...
        if (!isChild(mTitleTextView, mTitleInnerLayout)) {
            ...
            mTitleInnerLayout.addView(mTitleTextView, new Toolbar.LayoutParams(Toolbar.LayoutParams.WRAP_CONTENT, Toolbar.LayoutParams.WRAP_CONTENT));
        }
        ...
        if (!isChild(mSubtitleTextView, mTitleLayout)) {
            ...
            mTitleLayout.addView(mSubtitleTextView, new Toolbar.LayoutParams(Toolbar.LayoutParams.WRAP_CONTENT, Toolbar.LayoutParams.WRAP_CONTENT));
        }
        ...
        if (!isChild(mBackTextView)) {
            ...
            Toolbar.LayoutParams layoutParams = new Toolbar.LayoutParams(Toolbar.LayoutParams.WRAP_CONTENT, Toolbar.LayoutParams.MATCH_PARENT, Gravity.LEFT | Gravity.CENTER_VERTICAL);
            layoutParams.rightMargin = typedArray.getDimensionPixelSize(R.styleable.CubeToolbar_backMarginRight, dp2px(DEFAULT_BACK_MARGIN_RIGHT));
        ...
        if (!isChild(mRightTextView)) {
            ...
            Toolbar.LayoutParams layoutParams = new Toolbar.LayoutParams(Toolbar.LayoutParams.WRAP_CONTENT, Toolbar.LayoutParams.MATCH_PARENT, Gravity.RIGHT | Gravity.CENTER_VERTICAL);

            layoutParams.leftMargin = typedArray.getDimensionPixelSize(R.styleable.CubeToolbar_rightMarginLeft, dp2px(DEFAULT_BACK_MARGIN_RIGHT));
        ...
        if (!isChild(mLogoView)) {
            ...
            addView(mLogoView, new Toolbar.LayoutParams(Toolbar.LayoutParams.WRAP_CONTENT, Toolbar.LayoutParams.MATCH_PARENT, Gravity.LEFT | Gravity.CENTER_VERTICAL));
        }
