package cube.ware.service.widget.voice;
 ...
 * @date 2017/2/8
 */
public class AuditionButton extends android.support.v7.widget.AppCompatImageView {
    ...
    public AuditionButton(Context context, AttributeSet attrs) {
        ...
        mPaint.setColor(context.getResources().getColor(R.color.cube_secondary_divider));
