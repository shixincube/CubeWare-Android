...
public class CubeToolbar extends BaseToolbar implements View.OnClickListener,ICubeToolbar {
    ...
    protected void initCustomView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (!isChild(mTitleLayout)) {
            ...
            addView(mTitleLayout, new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT, Gravity.CENTER));
            ...
            if (!isChild(mTitleInnerLayout)) {
                ...
                mTitleLayout.addView(mTitleInnerLayout, new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT, Gravity.CENTER));
            }
        }
        ...
        if (!isChild(mBackTextView)) {
            ...
            LayoutParams layoutParams = new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.MATCH_PARENT, Gravity.LEFT | Gravity.CENTER_VERTICAL);
        ...
        if (!isChild(mRightTextView)) {
            ...
            LayoutParams layoutParams = new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.MATCH_PARENT, Gravity.RIGHT | Gravity.CENTER_VERTICAL);
        ...
        if (!isChild(mLogoView)) {
            ...
            addView(mLogoView, new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.MATCH_PARENT, Gravity.LEFT | Gravity.CENTER_VERTICAL));
        }
