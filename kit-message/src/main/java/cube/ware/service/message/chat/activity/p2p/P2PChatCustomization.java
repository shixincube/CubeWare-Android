...
public class P2PChatCustomization extends ChatCustomization {
    ...
    private class TitleP2PDetailButton extends ChatCustomization.OptionButton {
        ...
        @Override
        public void onClick(final Context context, View view, String chatId) {
            CubeUserRepository.getInstance().queryUser(chatId).observeOn(AndroidSchedulers.mainThread()).subscribe(new Action1<CubeUser>() {
                @Override
