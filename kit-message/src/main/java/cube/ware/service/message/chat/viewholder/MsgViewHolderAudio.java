...
import cube.ware.service.message.chat.listener.VoicePlayClickListener;
...
public class MsgViewHolderAudio extends BaseMsgViewHolder {
    ...
    public MsgViewHolderAudio(ChatMessageAdapter adapter, BaseViewHolder viewHolder, CubeMessageViewModel data, int position, Map<String, CubeMessage> selectedMap) {
