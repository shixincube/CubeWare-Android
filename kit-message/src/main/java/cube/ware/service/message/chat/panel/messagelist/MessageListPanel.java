...
public class MessageListPanel implements ICubeToolbar.OnTitleItemClickListener {
    ...
    private void init() {
        myCubeId = CubeCore.getInstance().getCubeId();
        initView();
        initToolBar(false);
        initData();
        initListener();
    ...
    public void updateView(List<CubeMessageViewModel> cubeMessages) {
        ...
        if (this.isFirstLoad) {
            ...
            this.mChatMessageAdapter.replaceData(cubeMessages);
            if (isHistory) {
            ...
            List<CubeMessageViewModel> mDataList = this.mChatMessageAdapter.getData();
            ...
            if (cubeMessages.size() > 0) {
                ...
                this.mChatMessageAdapter.addData(cubeMessages);
    ...
    public void deleteMessageList() {
        this.mContext.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                mChatMessageAdapter.setNewData(null);
            }
        });
    }
    ...
    private class MsgItemEventListener implements ChatMessageAdapter.ViewHolderEventListener {
        ...
        public void onFailedBtnClick(View clickView, CubeMessage cubeMessage) {
            ...
            if (index >= 0 && index < mChatMessageAdapter.getData().size()) {
                CubeMessageViewModel item = mChatMessageAdapter.getItem(index);
                ...
                mChatMessageAdapter.remove(index);
