 ...
 * Date: 2018/8/31.
 */
@Route(path = CubeConstants.Router.P2PChatActivity)
    ...
    public void selectImageFromCamera() {
        ...
        RxPermissionUtil.requestBasicPermission(this).subscribe(new Action1<Boolean>() {
            ...
            public void call(Boolean aBoolean) {
                if (aBoolean) {
                    RouterUtil.navigation(P2PChatActivity.this, CubeConstants.Router.RecordVideoActivity, REQUEST_CODE_CAMERA_IMAGE);
