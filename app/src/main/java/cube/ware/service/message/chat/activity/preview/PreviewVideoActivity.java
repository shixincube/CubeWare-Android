package cube.ware.service.message.chat.activity.preview;
...
import cube.ware.service.message.chat.videoplay.JCVideoPlayer;
import cube.ware.service.message.chat.videoplay.JCVideoPlayerStandard;
            ...
            CubeMessageRepository.getInstance().queryMessageBySn(mMessageSn)
                    ...
                    .subscribe(new Action1<CubeMessage>() {
                            ...
                            if (null != cubeMessage) {
                                if (cubeMessage.getMessageType() == CubeMessageType.Image) {
                                    ...
                                    if (!TextUtils.isEmpty(cubeMessage.getFileUrl())) {
                                        ...
                                        ToastUtil.showToast(App.getContext(),0,"视频地址为空！");
                                    }
                        ...
                        public void call(Throwable throwable) {
                            LogUtil.e(throwable);
                            ToastUtil.showToast(App.getContext(),0,"未找到视频");
                        }
                    });
        }
    }
