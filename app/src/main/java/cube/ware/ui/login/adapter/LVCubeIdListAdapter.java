...
public class LVCubeIdListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        GlideUtil.loadCircleImage(AppConstants.AVATAR_URL+mUsers.get(position).getCubeId(),mContext, cvAvator,DiskCacheStrategy.NONE,true,R.drawable.default_head_user);
        return convertView;
    }
}
