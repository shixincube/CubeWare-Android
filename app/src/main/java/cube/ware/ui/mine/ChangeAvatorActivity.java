...
public class ChangeAvatorActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        GlideUtil.loadImage(AppManager.getAvatarUrl() + SpUtil.getCubeId(), ChangeAvatorActivity.this, mIvAvator, DiskCacheStrategy.NONE, true, R.drawable.default_head_user);
    }
            ...
            public void onResponse(Call<ResultData<CubeAvator>> call, Response<ResultData<CubeAvator>> response) {
                if (response.isSuccessful()) {
                    ...
                    if (response.body().data != null) {
                        ...
                        user.setAvatar(response.body().data.getUrl());
