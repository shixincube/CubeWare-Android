 ...
 * date:   On 2018/9/5
 */
public class RVSelectAdapter  extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RVSelectAdapter(Context context,LinkedHashMap<String, CubeUser> selectedCubeMap,List<CubeUser> mCubeUsers,int userLimit) {
        mContext=context;
    ...
    protected void convert(MyHolder helper, CubeUser item) {
