package cube.ware.ui.chat.message;
...
import cube.ware.ui.chat.panel.input.InputPanelProxy;
import cube.ware.ui.chat.panel.input.MessageEditWatcher;
import cube.ware.ui.chat.panel.input.function.AudioFunction;
import cube.ware.ui.chat.panel.input.function.BaseFunction;
import cube.ware.ui.chat.panel.input.function.VideoFunction;
import cube.ware.ui.chat.panel.input.function.WhiteboardFunction;
...
public class MessageFragment extends Fragment implements InputPanelProxy, MessageEditWatcher {
     ...
     * 指定聊天消息
     */
    protected long mChatMessageSn = AppConstants.EXTRA_CHAT_MANAGER_SN;
    ...
    private void parseIntent(Bundle bundle) {
        ...
        hasParseIntent = true;
        this.mChatId = bundle.getString(AppConstants.EXTRA_CHAT_ID);
        this.mChatName = bundle.getString(AppConstants.EXTRA_CHAT_NAME);
        this.mSessionType = (CubeSessionType) bundle.getSerializable(AppConstants.EXTRA_CHAT_TYPE);
        this.mChatCustomization = (ChatCustomization) bundle.getSerializable(AppConstants.EXTRA_CHAT_CUSTOMIZATION);
        this.mChatMessageSn = bundle.getLong(AppConstants.EXTRA_CHAT_MESSAGE,AppConstants.EXTRA_CHAT_MANAGER_SN);
        ...
        if (this.mInputPanel == null) {
            this.mInputPanel = new InputPanel(mMessageListPanel, SpUtil.getCubeId(), container, container.mSessionType, mRootView, this.buildFunctionViewList());
