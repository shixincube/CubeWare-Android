...
import static cube.ware.AppConstants.REGEX.REGEX_AT_ALL;
import static cube.ware.AppConstants.REGEX.REGEX_AT_MEMBER;
...
public class AtHelper {
    ...
    public static ImageSpan getInputAtSpan(String name, float textSize) {
        ...
        return new ImageSpan(CubeUI.getInstance().getContext(), bmp, ImageSpan.ALIGN_BOTTOM);
    }
    ...
    public static void addAtTagSpan(Context context, Spannable spannable, int textSize) {
        Pattern pattern1 = Pattern.compile(REGEX_AT_MEMBER);
        ...
        Pattern pattern2 = Pattern.compile(REGEX_AT_ALL);
    ...
    public static String replaceAtTagToText(String content) {
       ...
       return content.replaceAll(REGEX_AT_ALL, "@全体成员");
    }
