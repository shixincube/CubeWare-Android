...
import cube.ware.R;
import cube.ware.ui.chat.activity.file.adapter.FileAdapter;
import cube.ware.ui.chat.activity.file.listener.OnFileItemSelected;
...
public class LocalFileFragment extends BaseFragment{
    ...
    protected void initListener() {
        ...
        mAdapter.setOnItemClickListener(new BaseRecyclerViewAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, BaseRecyclerViewHolder viewHolder, int position) {
                File file = mAdapter.getData(position);
    ...
    private void getFileListByDirector(String path) {
        ...
        this.mAdapter.refreshDataList(directorFileList);
    }
