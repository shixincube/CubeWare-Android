...
public class MsgViewHolderNotification extends BaseMsgViewHolder {
    ...
    public MsgViewHolderNotification(ChatMessageAdapter adapter, BaseRecyclerViewHolder viewHolder, CubeMessageViewModel data, int position, Map<String, CubeMessage> selectedMap) {
    ...
    private void handleTextNotification(String text) {
        ...
        //不是群消息并且发送发不是自己
        if (CubeCustomMessageType.DownLoad_Complete.getType().equals(mData.mMessage.getOperate()) && !mData.mMessage.isGroupMessage() && !mData.mMessage.getSenderId().equals(SpUtil.getCubeId())) {
