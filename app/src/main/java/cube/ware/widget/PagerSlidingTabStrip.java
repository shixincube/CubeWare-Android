...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int underlineColor = 0x0A000000;
    ...
    private int tabBackgroundResId = R.drawable.selector_pager_sliding_tab_bg;

    private Locale locale;

    private boolean isUnderlineFillWidth = false;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // draw indicator line_bg_green
        rectPaint.setColor(indicatorColor);

        // default: line_bg_green below current tab
        ...
        if (!isUnderlineFillWidth) {
            int space = ((int) lineRight - (int) lineLeft) / 4;
            lineLeft += space;
            lineRight -= space;
        }
    ...
    public void setUnderlineFillWidth(boolean isUnderlineFillWidth) {
        this.isUnderlineFillWidth = isUnderlineFillWidth;
    }

    public boolean getUnderlineFillWidth() {
        return this.isUnderlineFillWidth;
    }
}
