...
public class ConferenceListPresenter extends ConferenceListContract.Presenter {
    /**
     * 构造方法
     *
     * @param context
     * @param view
     */
    public ConferenceListPresenter(Context context, ConferenceListContract.View view) {
        super(context, view);
    }
