package com.common.utils.alive;
...
public class WatchDogService extends Service {
    ...
    protected final int onStart(Intent intent, int flags, int startId) {
        ...
        if (mTimerTask != null) return START_STICKY;
        ...
        //使用定时 任务，避免 Android 定制系统 JobScheduler / AlarmManager 唤醒间隔不稳定的情况
        ...
        mTimer.schedule(mTimerTask,0,DaemonEnv.getWakeUpInterval());
